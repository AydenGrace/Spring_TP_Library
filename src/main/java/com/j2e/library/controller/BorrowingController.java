...
public class BorrowingController {
    ...
    @GetMapping("/all/{id}")
    public ResponseEntity<List<Borrowing>> getAllOfUser(@PathVariable Long id) {
        try{
    ...
    public ResponseEntity<List<Borrowing>> getCurrentOfUser(@PathVariable Long id) {
        try{
    ...
    @PostMapping
    public ResponseEntity<String> post(@RequestBody Borrowing body) {
        System.out.println("[POST] request create new borrowing");
        try {
            borrowingService.create(body);
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<String> setReturnDate(@RequestBody Borrowing body, @PathVariable Long id) {
        try {
